...
//
// Covers 34 codegen-emitted methods across 11 modality
...
private enum RAGGeneratedProtoABI {
    ...
    typealias SearchFn = @convention(c) (
        rac_handle_t?,
        UnsafePointer<UInt8>?,
        Int,
        UnsafeMutablePointer<rac_proto_buffer_t>?
    ...
    static let searchName = "rac_rag_search_proto"
    ...
    static let search = NativeProtoABI.load(searchName, as: SearchFn.self)
...
extension CppBridge.RAG {
    ...
    public nonisolated func search(handle: rac_handle_t, _ request: RARAGSearchRequest) throws -> RARAGSearchResponse {
        return try NativeProtoABI.invoke(
            request,
            on: handle,
            symbol: RAGGeneratedProtoABI.search,
            symbolName: RAGGeneratedProtoABI.searchName,
            responseType: RARAGSearchResponse.self
        )
    }
